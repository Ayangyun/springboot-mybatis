...
public class DateUtil {
    ...
    public static String getDateYYYYMMDDHHMMSSString(Date date) {
    ...
    public static Date getFirstDayOfMonth(@NonNull Date date) {
        Calendar calendar = Calendar.getInstance();
        calendar.setTime(date);
        calendar.set(Calendar.DAY_OF_YEAR, calendar.get(Calendar.DAY_OF_YEAR) - calendar.get(Calendar.DAY_OF_MONTH) + 1);
     ...
     * @return
     */
    public static String getTimeDifferential(Date formatTime1, Date formatTime2) {
     ...
     * @return
     */
    public static int getHourDifferential(Date formatTime1, Date formatTime2) {
        SimpleDateFormat timeformat = new SimpleDateFormat("yyyy-MM-dd,HH:mm:ss");
        long t1 = 0L;
        long t2 = 0L;
        try {
     ...
     * @return
     */
    public static long getTimeDifferentialMS(Date formatTime1, Date formatTime2) {
        SimpleDateFormat timeformat = new SimpleDateFormat("yyyy-MM-dd,HH:mm:ss");
        long t1 = 0L;
        long t2 = 0L;
        try {
...
//    	time = Long.valueOf(times);
     ...
     * @return
     */
    public static String getTimeDayBefore(Date date,int count){
        Calendar calendar = Calendar.getInstance();
        Date dBefore = null;
        calendar.setTime(date);
        ...
        try {
            ...
            defaultStartDate = sdf.format(dBefore);
     ...
     * @return
     */
    public static String getTimeDayBefore2(Date date,int count){
        Calendar calendar = Calendar.getInstance();
        Date dBefore = null;
        calendar.setTime(date);
        calendar.add(Calendar.DAY_OF_MONTH, count);
